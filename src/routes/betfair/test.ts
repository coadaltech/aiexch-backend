...
// request to get the token and the app key
// curl -k -i -H "Accept: application/json" -H "X-Application: 2epGhiLEyS8jKMKP" -X POST -d 'username=hkddpro22&password=Ch@ngeme112233' https://identitysso.betfair.com/api/login
...
// curl -v -X POST "https://api.betfair.com/exchange/betting/rest/v1.0/listEventTypes/" \
//                                                     -H "X-Application: 2epGhiLEyS8jKMKP" \
//                                                     -H "X-Authentication: 7NCCXeg2qeoFHWEcb5iegb64Xqjqkq+ayVzxKtzdmeQ=" \
//                                                     -H "Accept: application/json" \
//                                                     -H "Content-Type: application/json" \
//                                                     -d '{"filter":{}}'


// get competions from the event type id
// curl -X POST "https://api.betfair.com/exchange/betting/rest/v1.0/listCompetitions/" \
//                            -H "X-Application: 2epGhiLEyS8jKMKP" \
//                            -H "X-Authentication: 7NCCXeg2qeoFHWEcb5iegb64Xqjqkq+ayVzxKtzdmeQ=" \
//                            -H "Accept: application/json" \
//                            -H "Content-Type: application/json" \
...
// get the events from the competition id
// curl -X POST "https://api.betfair.com/exchange/betting/rest/v1.0/listEvents/" \
//                            -H "X-Application: 2epGhiLEyS8jKMKP" \
//                            -H "X-Authentication: 7NCCXeg2qeoFHWEcb5iegb64Xqjqkq+ayVzxKtzdmeQ=" \
//                            -H "Accept: application/json" \
//                            -H "Content-Type: application/json" \
...
//                              "filter": {
//                                "eventTypeIds": ["4"],
//                                "competitionIds": ["11365612"]
//                              }
//                            }'


// get the events directly from the event type id
// curl -X POST "https://api.betfair.com/exchange/betting/rest/v1.0/listEvents/" \
//   -H "X-Application: 2epGhiLEyS8jKMKP" \
//   -H "X-Authentication: d1Q3nma36gGI0/cFnwhgKo/T5l34K+gOHM3/DezHovU=" \
//   -H "Accept: application/json" \
//   -H "Content-Type: application/json" \
//   -d '{
//         "filter": {
...
// 
// curl -X POST "https://api.betfair.com/exchange/betting/rest/v1.0/listMarketCatalogue/" \
//                                 -H "X-Application: 2epGhiLEyS8jKMKP" \
//                                 -H "X-Authentication: 7NCCXeg2qeoFHWEcb5iegb64Xqjqkq+ayVzxKtzdmeQ=" \
//                                 -H "Accept: application/json" \
//                                 -H "Content-Type: application/json" \
